...
- [x] **Git hook 激活**（2026-06-10）：`git config core.hooksPath TianShu/.githooks`——hook 文件存在不等于 hook 已激活。审计发现 hooksPath 此前未设置，所有提交实际绕过了 pre-commit 门禁。详见本文 §9.8"第八次认知提升"。
